  ...
  resources :employees do
    route_param :employee_id do
      resources :allowance_and_deductions do
        ...
        post do
          allowance_and_deduction = AllowanceAndDeduction.new.create_allowance_and_deduction(params)
        ...
        delete ':id' do
          allowance_and_deduction = AllowanceAndDeduction.new.find_and_destroy_employee_allowance_and_deduction(params)
